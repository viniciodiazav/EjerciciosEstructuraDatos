...
int main()
{
    ...
    // ============= TAMANOS DE LOS TIPOS DE DATOS =============
    cout << "Tamano de AutoPE = " << sizeof(aPE) << " bytes" << endl;
    cout << "Tamano de AutoPOO = " << sizeof(aPOO) << " bytes" << endl;
    cout << "Tamano de PersonaPE = " << sizeof(pPE) << " bytes" << endl;
    cout << "Tamano de PersonaP00 = " << sizeof(pPOO) << " bytes" << endl;
    return 0;
}
